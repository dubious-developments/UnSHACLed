        ...
        return (
            <div style={{marginTop: '2em'}}>
                ...
                <p> To be able to use the UnSHACLed editor you must create an account at first. The following sections
                    will aide the end user in setting up such an account, signing in with the account and signing from
                    the editor.
                </p>

                {/** Create an account **/}

                <Header as='h2' color="teal"> Create an account </Header>
                <p>
                ...
                <p>
                    ...
                    All instruction are at the sign-up page itself, but will be repeated here once more. To create an
                ...
                <p>
                    ...
                    choose should containt at least one lowercase letter, one numeral and at least seven characters.
                ...
                <p>
                    After succesfully setting up your account, you can go to the login page, to authenticate yourself
                ...
                <Header as='h2' color="teal"> Login to UnSHACLed </Header>
                <p> The following will guide you through the process of <b> creating an account </b>.</p>
                <p> After you succusfully set up an account to login, you can navigate to the login-page by clicking
                ...
                <p>
                    ...
                    you will see a confirmation message, indicating you succesfully authenticated to our server. This
                    message could va ry, but should look like the following:
                </p>
                <Image src={s28} centered={true} style={this.imgMargin}/>
                <p>
                    After succesfully completing the authentication, you can close the pop-up window and return
                ...
                <Header as='h2' color="teal"> Logout </Header>
                ...
                <p>
                    ...
                    editor. To logout, click the user info dropdown in the right corner of the top toolbar. This
                ...
                <p>
                    ...
                    after which you are succesfully logged out. If you want to login with another account, please
