        ...
        return (
            <div style={{marginTop: '2em'}}>
                ...
                <p> There are a number of possible ways to store or retrieve files in the UnSHACLed editor. Two
                    ...
                    UnSHACLed, users need to create a GitHub account. This account is linked to the UnSHACLed editor
                ...
                <p> Next, select the 'Open local graph' option from the drop down. A horizontal drop down will open
                ...
                <Image src={s31} centered={true} style={this.imgMargin}/>
                <p> First open the 'File' drop down from the toolbar, as made visible in the figure above. This will
                    bring up the following:</p>
                <Image src={s32} centered={true} style={this.imgMargin}/>
                <p> Next select the 'Save local graph' option from the drop down. A horizontal drop down will open
                ...
                <p>
                    ...
                    a file first as described in the section on how to 'open local files'. If files were openened, the
                    editor should give the follwiing option:
                </p>
                ...
                <p>
                    ...
                    browser and stored wherever you set your Downloads folder.
                </p>

                {/** Open files to your account **/}

                <Header as='h2' color="teal" id="3.3"> Open files from your account </Header>
                <p> The following will guide you through the process of <b> opening files from your remote account </b>
                    into the editor.
                </p>
                <Image src={s31} centered={true} style={this.imgMargin}/>
                <p> First open the 'File' dropdown from the toolbar, as made visible in the figure above. This will
                ...
                <p> Through this pop-up screen, select one of your projects from the selection field. If your
                ...
                <p> Now select a file of your choice within your previously selected project in the appeared
                    ...
                    If you want to cancel the process of opening a remote graph, you can either
                ...
                <p> First open the 'File' dropdown from the toolbar, as made visible in the figure above. This will
                    bring up the following:</p>
                <Image src={s32} centered={true} style={this.imgMargin}/>
                <p> Next select the 'Save graph to account' option from the drop down. A horizontal drop down will open
                    which allows the user to choose between the currently opened files. Two options are available here.
                    If no files were opened, a similar option as the following can be observed:
                </p>
                <Image src={s37} centered={true} style={this.imgMargin}/>
                <p>
                    As no files were opened in the editor, the user is not able to save. If you see this, please open
                    a file first as described in the section on how to 'open graph from your account'.
                    If files were opened, the editor should give a similar option as the following:
                </p>
                <Image src={s38} centered={true} style={this.imgMargin}/>
                <p>
                    Here one is able to choose which of the currently opened files to store remotely. After selecting
                ...
                <p> The following will guide you through the process of <b> creating a new project for your
                    remote account </b>
                </p>
                <Image src={s31} centered={true} style={this.imgMargin}/>
                <p> First open the 'File' drop down from the toolbar, as made visible in the figure above. This will
                    bring up the following:</p>
                <Image src={s32} centered={true} style={this.imgMargin}/>
                <p> Next select the 'New Project' option from the drop down. Following pop-up will be visible on screen:
                </p>
                ...
                <p>
                    ...
                    disabled. If you are satisfied with your chosen project name, click the 'Create' button. The editor
                ...
                <p> First open the 'File' drop down from the toolbar, as made visible in the figure above. This will
                    bring up the following:</p>
                <Image src={s32} centered={true} style={this.imgMargin}/>
                <p> Next select the 'New File' option from the drop down. Following pop-up will be visible on screen:
                </p>
                ...
                <p>
                    ...
                    in the input field. After selecting a filename,
                    specify the type of file you want to create. Choose 'data' if you
                    want to create a data graph or choose 'SHACL' if you want to create a SHACL graph.
                    Whenever the input field is not empty, the 'Create' button will no longer be
                ...
                <p> First open the 'File' dropdown from the toolbar, as made visible in the figure above. This will
                    bring up the following:</p>
                <Image src={s32} centered={true} style={this.imgMargin}/>
                <p> Next select the 'Load workspace' or'Save workspace' option from the drop down.
                </p>
                <p>
